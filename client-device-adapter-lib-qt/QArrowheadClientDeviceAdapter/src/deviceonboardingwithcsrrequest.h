...
namespace arrowhead{
    struct DeviceOnboardingWithCsrRequest{
        ...
        DeviceOnboardingWithCsrRequest() = default;
        DeviceOnboardingWithCsrRequest(std::string certificateSigningRequest, ArrowheadDevice device, std::string endOfValidity, std::map<std::string,std::string> metadata, int version):
...
#endif // DEVICEONBOARDINGWITHCSRREQUEST_H
